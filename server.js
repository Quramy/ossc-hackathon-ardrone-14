(function() {
	...
	app.configure(function() {
		...
		return app.use("/components", express.static(path.join(__dirname,
				'/bower_components')));
	});
	...
	socket.subscribe("/drone/move", function(cmd) {
		...
		return typeof drone[_name = cmd.action] === "function" ? drone[_name]
				(cmd.speed) : void 0;
	});
	...
	app.get('/autocmd/:name', autocmd.index(client));
}).call(this);
